...
?>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="banner-wrapper-4 mb-30">
                        <a href="#"><img src="img/banner/37.jpg" alt=""></a>
                ...
                <div class="col-lg-4">
                    <div class="banner-wrapper-4 mb-30">
                        <a href="#"><img src="img/banner/21.jpg" alt=""></a>
    ...
    <div class="team-area">
        <img src="img/banner/39.jpg" alt="">
    </div>
    <!-- testimonials area start -->
    <div class="testimonials-area pt-100 pb-95 bg-img" style="background-image: url(img/bg/7.jpg)">
        <div class="container">
